...
@section('content')
                            	...
                            	<div class="row">
                                	<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                                		<ul class="nav nav-tabs nav-stacked text-center">
                                            ...
                                            <li  class="active"><a href="{{route('site.hotelProfile')}}"><span><i class="fa fa-user"></i></span>البروفايل</a></li>
                                            @endif
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="side-bar fullform">
                                                            <div class="booking-form booking-form-block">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <form method="post" enctype="multipart/form-data" action="{{route('site.postHotelGallery')}}" class="dropzone" id="my-dropzone">
                                                                            {{csrf_field()}}
                                                                            <div class="row mg-b-25">
                                                                                <div class="col-lg-12">
                                                                                    <div class="form-group rs-select2">
                                                                                    <label class="control-label">اختر فندق</label>
                                                                                    <select class="select2" name="hotel_id">
                                                                                        <option>اختر فندق</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.addHotelRooms')}}" class="btn btn-block btn-orange">اضافة غرف الفندق</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                            	...
                            	<div class="row">
                                	...
                                	<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                                		<ul class="nav nav-tabs nav-stacked text-center">
                                                ...
                                                <li  class="active"><a href="{{route('site.hotelProfile')}}"><span><i class="fa fa-user"></i></span>Profile</a></li>
                                                @endif
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.addHotelRooms')}}" class="btn btn-block btn-orange">Add Hotel Rooms</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                                        </div><!-- end panel-detault -->
    ...
    @endif
@endsection
@include('site.pages.hotel_gallery.scripts')