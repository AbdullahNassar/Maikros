...
@section('content')
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><h4>اضافة مميزات الفندق</h4></div>
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.addHotelFacilities')}}" class="btn btn-block btn-orange">اضافة وسائل الراحة</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.addHotelFacilities')}}" class="btn btn-block btn-orange">Add Means Of Comfort</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                                        </div><!-- end panel-detault -->
    ...
    @endif
@endsection
@include('site.pages.add_features.scripts')