            ...
            <div class="container">
                <div class="row">        	
                            ...
                            <div class="row">
                              <div class="filtr-container">
                                @foreach($hotels as $hotel)
                                    @if(Config::get('app.locale') == 'ar')
                                    <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="{{$hotel->place_id}}">
                                        <div class="main-block hotel-block">
                                            ...
                                            <div class="main-info hotel-info">
                                                ...
                                                <div class="grid-btn">
                                                    <a href="{{ route('site.hotel' , ['id' => $hotel->id]) }}" class="btn btn-orange btn-block btn-lg">حجز الآن</a>
                                                </div><!-- end grid-btn -->
                                            </div>
                                        </div><!-- end hotel-block -->
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="{{$hotel->place_id}}">
                                        <div class="main-block hotel-block">
                                            ...
                                            <div class="main-info hotel-info">
                                                ...
                                                <div class="grid-btn">
                                                    <a href="{{ route('site.hotel' , ['id' => $hotel->id]) }}" class="btn btn-orange btn-block btn-lg">Book Now</a>
                                                </div><!-- end grid-btn -->
                                            </div>
                                        </div><!-- end hotel-block -->
                                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar">
                        <form method="GET" action="{{route('site.hotelFilter')}}">
                            <div class="side-bar-block filter-block">
                                <h3>رتب حسب التصفية</h3>
                                <p>اكتشف فنادق أحلامك اليوم</p>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar">
                            ...
                            <form method="GET" action="{{route('site.hotelFilter')}}">
                                <div class="side-bar-block filter-block">
                                    ...
                                    <p>Find your dream hotels today</p>
...
@endsection
@include('site.pages.hotels.scripts')