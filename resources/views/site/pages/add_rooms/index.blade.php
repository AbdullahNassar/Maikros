...
@section('content')
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><h4>اضافة غرفة</h4></div>
                                            <div class="panel-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">اسم الغرفة باللغة العربية</label>
                                                                                <input class="form-control" type="text" name="r_name_ar" placeholder="اسم الغرفة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">اسم الغرفة باللغة الانجليزية</label>
                                                                                <input class="form-control" type="text" name="r_name_en" placeholder="اسم الغرفة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">تفاصيل الغرفة باللغة العربية</label>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">تفاصيل الغرفة باللغة الانجليزية</label>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="number" name="max" placeholder="عدد الافراد">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="number" name="nights" placeholder="عدد الغرف">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.addHotelFeatures')}}" class="btn btn-block btn-orange">اضافة مزايا الفندق</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                            ...
                                                            <div class="booking-form booking-form-block">
                                                                <form method="post" id="room_form" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Arabic Room Name</label>
                                                                                <input class="form-control" type="text" name="r_name_ar" placeholder="Arabic Room Name">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">English Room Name</label>
                                                                                <input class="form-control" type="text" name="r_name_en" placeholder="English Room Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Guests Max Number</label>
                                                                                <input class="form-control" type="number" name="max" placeholder="Guests Max Number">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="number" name="nights" placeholder="Number of Rooms">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="checkbox custom-check">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.addHotelFeatures')}}" class="btn btn-block btn-orange">Add Hotel Features</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                                        </div><!-- end panel-detault -->
    ...
    @endif
@endsection
@include('site.pages.add_rooms.scripts')