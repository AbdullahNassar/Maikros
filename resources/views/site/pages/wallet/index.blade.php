                            	...
                            	<div class="row">
                                	<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                                		<ul class="nav nav-tabs nav-stacked text-center">
                                            ...
                                            <li><a href="{{route('site.wallet')}}"><span><i class="fa fa-credit-card"></i></span>المحفظة</a></li>
                                        </ul>
                                    </div><!-- end columns -->
                            	...
                            	<div class="row">
                                	...
                                	<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                                		<ul class="nav nav-tabs nav-stacked text-center">
                                                ...
                                                <li><a href="{{route('site.wallet')}}"><span><i class="fa fa-credit-card"></i></span>Wallet</a></li>
                                        </ul>
                                    </div><!-- end columns -->
