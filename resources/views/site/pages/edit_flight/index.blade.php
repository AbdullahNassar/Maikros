...
@section('content')
                                                                ...
                                                                <form method="post" id="flight_form" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="user-img-upload">
                                                                            ...
                                                                            <img src="{{asset('storage/uploads/flight/'.$flight->image)}}" id="blah" class="img-circle" alt="">
                                                                            @else
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="flight_name_ar" value="{{$flight->flight_name_ar}}" placeholder="اسم الرحلة باللغة العربية">     
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="flight_name_en" value="{{$flight->flight_name_en}}" placeholder="اسم الرحلة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="duration_ar" value="{{$flight->duration_ar}}" placeholder="مدة الرحلة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="duration_en" value="{{$flight->duration_en}}" placeholder="مدة الرحلة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">البداية</label>
                                                                                <input class="form-control" type="text" name="start" value="{{$flight->start}}" placeholder="البداية">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">النهاية</label>
                                                                                <input class="form-control" type="text" name="end" value="{{$flight->end}}" placeholder="النهاية">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">السعر</label>
                                                                                <input class="form-control" type="number" name="price" value="{{$flight->price}}" placeholder="السعر">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">الكود</label>
                                                                                <input class="form-control" type="text" name="code" value="{{$flight->code}}" placeholder="الكود">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">تفاصيل الرحلة باللغة العربية</label>
                                                                                <textarea class="form-control" type="text" name="content_ar">{{$flight->content_ar}}</textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control" type="text" name="content_en">{{$flight->content_en}}</textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="dashboard-wrapper">
                            	<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><h4>Edit Flight</h4></div>
                                            <div class="panel-body">
                                            	<div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="side-bar fullform">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="hidden" name="flight_id" value="{{$flight->id}}"> 
                                                                                <input class="form-control" type="hidden" name="user_id" value="{{Auth::guard('members')->user()->id}}" >
                                                                                <input class="form-control" type="text" name="flight_name_ar" value="{{$flight->flight_name_ar}}" placeholder="Arabic Flight Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="flight_name_en" value="{{$flight->flight_name_en}}" placeholder="English Flight Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="sub_name_ar" value="{{$flight->sub_name_ar}}" placeholder="Arabic Duration">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="sub_name_en" value="{{$flight->sub_name_en}}" placeholder="English Duration">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Start</label>
                                                                                <input class="form-control" type="number" name="start" value="{{$flight->start}}" placeholder="Start">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">End</label>
                                                                                <input class="form-control" type="number" name="end" value="{{$flight->end}}" placeholder="End">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Price</label>
                                                                                <input class="form-control" type="number" name="price" value="{{$flight->price}}" placeholder="Price">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Code</label>
                                                                                <input class="form-control" type="number" name="code" value="{{$flight->code}}" placeholder="Code">                                    
                                                                            </div>
                                                                        </div>
    ...
    @endif
@endsection
@include('site.pages.edit_flight.scripts')