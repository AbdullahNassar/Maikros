...
@section('content')
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <div class="other-links">
                                    	<p class="link-line">هل لديك حساب بالفعل ؟ <a href="{{ route('site.companylogin') }}">دخول</a></p>
                                    </div>
                                </div><!-- end custom-form -->
                        ...
                        <div class="col-sm-12">
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <div class="other-links">
                                    	<p class="link-line">Do you have account ?   <a href="{{ route('site.companylogin') }}">Login</a></p>
                                    </div>
                                </div><!-- end custom-form -->
    ...
    @endif
@endsection
@include('site.pages.company_register.scripts')