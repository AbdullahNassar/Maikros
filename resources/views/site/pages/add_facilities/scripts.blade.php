...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#facility_form').on('submit', function(event){
                ...
                $.ajax({
                    url:"{{ route('site.postHotelFacilities') }}",
                    method:"POST",
                    data:new FormData(this),
                    dataType:"json",
                    cache: false,
                    ...
                    success:function(data)
                    {
                        ...
                        {
                            toastr.success('Hotel Room is inserted successfully', 'Success!', {timeOut: 3000});
        ...
        $('#facility_form').on('submit', function(event){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        {
                            toastr.success('تم اضافة الغرفة بنجاح', 'تم!', {timeOut: 3000});
                            $('#facility_form')[0].reset();
