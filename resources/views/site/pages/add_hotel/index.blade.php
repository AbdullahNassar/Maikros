...
@section('content')
                            	...
                            	<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><h4>اضافة فندق</h4></div>
                                            <div class="panel-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="hotel_name_ar" placeholder="اسم الفندق باللغة العربية">   
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="hotel_name_en" placeholder="اسم الفندق باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="street_ar" placeholder="اسم الشارع باللغة العربية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="street_en" placeholder="اسم الشارع باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">البعد عن الحرم باللغة العربية</label>
                                                                                <input class="form-control" type="text" name="far_ar" placeholder="البعد عن الحرم باللغة العربية">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">البعد عن الحرم باللغة الانجليزية</label>
                                                                                <input class="form-control" type="text" name="far_en" placeholder="البعد عن الحرم باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">الأماكن القريبة باللغة العربية</label>
                                                                                <input class="form-control" type="text" name="remote_ar" placeholder="الأماكن القريبة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">الأماكن القريبة باللغة الانجليزية</label>
                                                                                <input class="form-control" type="text" name="remote_en" placeholder="الأماكن القريبة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="number" name="stars" placeholder="عدد النجوم">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="number" name="discount" placeholder="الخصم">                                    
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.hotelGallery')}}" class="btn btn-block btn-orange">اضافة صور الفندق</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="dashboard-wrapper">
                            	<div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content user-profile">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><h4>Add Hotel</h4></div>
                                            <div class="panel-body">
                                            	<div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="side-bar fullform">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="hotel_name_ar" placeholder="Arabic Hotel Name">      
                                                                                <input class="form-control" type="hidden" name="user_id" value="{{Auth::guard('members')->user()->id}}" >                              
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="hotel_name_en" placeholder="English Hotel Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="street_ar" placeholder="Arabic Street Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="street_en" placeholder="English Street Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="far_ar" placeholder="Arabic Distance">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="far_en" placeholder="English Distance">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Arabic Remote Places</label>
                                                                                <input class="form-control" type="text" name="remote_ar" placeholder="Arabic Remote Places">                                    
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">English Remote Places</label>
                                                                                <input class="form-control" type="text" name="remote_en" placeholder="English Remote Places">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12 col-md-12 col-lg-12 no-sp-r">
                                                                            <div class="form-group rs-select2">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="number" name="stars" placeholder="Stars">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <a href="{{route('site.hotelGallery')}}" class="btn btn-block btn-orange">Add Hotel Images</a>
                                                    </div>
                                                </div>
                                            </div><!-- end panel-body -->
                                        </div><!-- end panel-detault -->
    ...
    @endif
@endsection
@include('site.pages.add_hotel.scripts')