...
@section('content')
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="p_name_ar" placeholder="اسم البرنامج باللغة العربية">   
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="p_name_en" placeholder="اسم البرنامج باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="sub_name_ar" placeholder="مدة الرحلة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="sub_name_en" placeholder="مدة الرحلة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="mekkah_ar" placeholder="عدد الليالى فى مكة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="mekkah_en" placeholder="عدد الليالى باللغة فى مكة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">عدد الليالى فى المدينة باللغة العربية</label>
                                                                                <input class="form-control" type="text" name="madenah_ar" placeholder="عدد الليالى فى المدينة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="madenah_en" placeholder="عدد الليالى فى المدينة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">عدد الليالى فى جدة باللغة العربية</label>
                                                                                <input class="form-control" type="text" name="jeddah_ar" placeholder="عدد الليالى فى جدة باللغة العربية">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="jeddah_en" placeholder="عدد الليالى فى جدة باللغة الانجليزية">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="p_name_ar" placeholder="Arabic Program Name">   
                                                                                <input class="form-control" type="hidden" name="user_id" value="{{Auth::guard('members')->user()->id}}" >                                 
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="p_name_en" placeholder="English Program Name">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="mekkah_ar" placeholder="Arabic Duration in Mekkah">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="mekkah_en" placeholder="English Duration in Mekkah">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="madenah_ar" placeholder="Arabic Duration in Madinah">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="madenah_en" placeholder="English Duration in Madinah">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="jeddah_ar" placeholder="Arabic Duration in Jeddah">                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control" type="text" name="jeddah_en" placeholder="English Duration in Jeddah">                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control" type="text" name="hotel_ar"></textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control" type="text" name="hotel_en"></textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Arabic Flights Details</label>
                                                                                <textarea class="form-control" type="text" name="flight_ar"></textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control" type="text" name="flight_en"></textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Arabic Services Details</label>
                                                                                <textarea class="form-control" type="text" name="service_ar"></textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea class="form-control" type="text" name="service_en"></textarea>                                    
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6 col-md-12 col-lg-6 no-sp-r">
                                                                            <div class="checkbox custom-check">
    ...
    @endif
@endsection
@include('site.pages.add_program.scripts')