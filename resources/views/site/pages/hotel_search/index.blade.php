                ...
                <div class="container">
                    <div class="row">        	
                                ...
                                <div class="list-content">
                                    ...
                                    <div class="list-info room-info">
                                        <div class="arrow pull-right">
                                            <span class="rate-tag"><b>{{$h['rate']}}</b>التقييم</span>
                                        </div>
                                        <h3 class="block-title"><a href="#">{{$h['hotel_name_ar']}}</a></h3>
                                        <br><br>
                                        ...
                                        <form action="{{ route('site.hotelRooms') }}" method="GET">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 side-bar left-side-bar">
                            ...
                            <ul class="umrahtak">
                                <li><form method="GET" action="{{route('site.mekkahSearch')}}">
                                    <input type="hidden" name="hotel" value="مكة">
                                    <input type="hidden" name="adults" value="{{$adults}}">
                                        <input type="hidden" name="children" value="{{$children}}">
                                        <input type="hidden" name="town" value="{{$town}}">
                                        <input type="hidden" name="to_mekkah" value="{{$to_mekkah}}">
                                        ...
                                        <input type="hidden" name="s_quantity" value="{{$s_quantity}}">
                                        <input type="hidden" name="duration" value="{{$duration}}">
                                <button type="submit" class="btn btn-orange btn-block btn-lg">فنادق مكة <span><i class="fa fa-plus-circle"></i></span> </button>
                                </form></li>
                                @if($hotel == "مكة المدينة")
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 content-side">
                        ...
                        <div class="list-block main-block room-block">
                            <div class="list-content">
                                ...
                                <div class="list-info room-info">
                                    <div class="arrow pull-right">
                                        <span class="rate-tag"><b>{{$h['rate']}}</b>Rate</span>
                                    </div>
                                    <h3 class="block-title"><a href="#">{{$h['hotel_name_en']}}</a></h3>
                                    <br><br>
                        ...
                        <ul class="umrahtak">
                            ...
                            <li><form method="GET" action="{{route('site.mekkahSearch')}}">
                                ...
                                <input type="hidden" name="adults" value="{{$adults}}">
                                    ...
                                    <input type="hidden" name="s_quantity" value="{{$s_quantity}}">
                                    <input type="hidden" name="duration" value="{{$duration}}">
                            <button type="submit" class="btn btn-orange btn-block btn-lg">Mekkah Hotels <span><i class="fa fa-plus-circle"></i></span> </button>
                            </form></li>
                            <li><form method="GET" action="{{route('site.madinahSearch')}}">
