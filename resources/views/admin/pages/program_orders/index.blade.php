...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('programOrder.get')}}">Program Orders</a>
            <span class="breadcrumb-item active">Program Orders Table</span>
        </nav>
        </div><!-- br-pageheader -->
...
@endsection
@include('admin.pages.program_orders.scripts')