...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('office.get')}}">Offices</a>
            <span class="breadcrumb-item active">Offices Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-section-wrapper">
            ...
            <table id="office_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
        ...
        <!-- modal -->
        <div id="officeModal" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center modal-lg" role="document">
            <div class="modal-content bd-0 tx-14">
                <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Office</h6>
                ...
                <div class="form-layout">
                    <form method="post" id="office_form" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="hidden" value="office" name="storage" >
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Office Name</label>
                                    <input class="form-control" type="text" name="office_name_ar" id="office_name_ar">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Office Name</label>
                                    <input class="form-control" type="text" name="office_name_en" id="office_name_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Country</label>
                                    <input class="form-control" type="text" name="country_ar" id="country_ar">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Country</label>
                                    <input class="form-control" type="text" name="country_en" id="country_en">
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Address</label>
                                    <input class="form-control" type="text" name="address_ar" id="address_ar">
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="office-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h2 class="mg-b-5 tx-semibold tx-inverse" id="office-name"></h2>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Office Country:</span>
                                    <span class="mg-b-20" id="office-country"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Office Phone:</span>
                                    <span class="mg-b-20" id="office-phone"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Office Address:</span>
                                    <span class="mg-b-20" id="office-address"></span>
                                </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
...
@endsection
@include('admin.pages.office.scripts')