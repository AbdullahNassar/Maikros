...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('room.get')}}">Hotel Rooms</a>
            <span class="breadcrumb-item active">Hotel Rooms Table</span>
        </nav>
        </div><!-- br-pageheader -->
        <div class="br-pagebody">
        <div class="br-section-wrapper">
            <button class="btn btn-oblong btn-outline-primary mg-b-10 float-right" id="add_data" type="button" name="add">Add New Hotel Room</button>
            ...
            <table id="room_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
        ...
        <div id="roomModal" class="modal fade">
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Hotel Room</h6>
                ...
                <div class="form-layout">
                    <form id="room_form" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="hidden" value="room" name="storage" >
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Hotel Room Name</label>
                                    <input class="form-control" type="text" name="r_name_ar" id="r_name_ar">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Hotel Room Name</label>
                                    <input class="form-control" type="text" name="r_name_en" id="r_name_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    ...
                                    <input class="form-control" type="number" name="nights" id="nights">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="room-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h2 class="mg-b-5 tx-semibold tx-inverse" id="room-name"></h2>
                                <h5 class="mg-b-5 tx-inverse lh-2 " id="room-title"></h5>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Hotel Room Content:</span>
                                    <span class="mg-b-20" id="room-content"></span>
                                </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
...
@endsection
@include('admin.pages.hotel_rooms.scripts')