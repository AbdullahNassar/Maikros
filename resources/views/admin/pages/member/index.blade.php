...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('member.get')}}">Members</a>
            <span class="breadcrumb-item active">Members Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-section-wrapper">
            ...
            <table id="member_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
        ...
        <div id="memberModal" class="modal fade">
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Member</h6>
                            ...
                            <div class="col-lg-3">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="file" id="imgInp" class="upload" name="member_image">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                      ...
                                      <option value="company">Tourism Company</option>
                                      <option value="hotel">Hotel</option>
                                      <option value="services">Tourism Services</option>
                                    </select>
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-3">
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="member-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h2 class="mg-b-5 tx-semibold tx-inverse" id="member-name"></h2>
                                <h5 class="mg-b-5 tx-inverse lh-2 " id="member-title"></h5>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Member Bio:</span>
                                    <span class="mg-b-20" id="member-bio"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Member Address:</span>
                                    <span class="mg-b-20" id="member-address"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Member Email:</span>
                                    <span class="mg-b-20" id="member-email"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Member Mobile:</span>
                                    <span class="mg-b-20" id="member-mobile"></span>
                                </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
...
@endsection
@include('admin.pages.member.scripts')