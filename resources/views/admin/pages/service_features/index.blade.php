...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('feature.get')}}">Service Features</a>
            <span class="breadcrumb-item active">Service Features Table</span>
        </nav>
        </div><!-- br-pageheader -->
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    ...
                                    <select class="select2 pmd-select2 form-control" name="service_id" id="service_id">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
...
@endsection
@include('admin.pages.service_features.scripts')