    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        ...
        <div class="br-section-wrapper">
            ...
            <div class="table-wrapper">
                    <form method="post" enctype="multipart/form-data" action="{{route('ajaxdata.addServiceImages', ['id' => $service->id])}}" class="dropzone" id="my-dropzone">
                        {{csrf_field()}}
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-12">
                            <div class="row" id="gallery_container">
                                ...
                                <input type="hidden" name="service_id" value="{{$g->service_id}}" />
                                    <div class="col-md">
                                        <div class="card bd-0">
                                            <img class="card-img img-fluid" src="{{asset('storage/uploads/gallery').'/'.$g->image}}" alt="Image">
                                        </div><!-- card -->
                                        <br><a href="{{route('ajaxdata.removeServiceImages', ['id' => $g->id])}}" class="btn btn-outline-danger">Remove</a><br>
                                    </div><!-- col -->
                                @endforeach
                            </div>
                        </div>
