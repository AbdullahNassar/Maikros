...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('slider.get')}}">Sliders</a>
            <span class="breadcrumb-item active">Sliders Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-section-wrapper">
            ...
            <table id="slider_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Title</th>
        ...
        <div id="sliderModal" class="modal fade">
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Slider</h6>
                            ...
                            <div class="col-lg-12">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="file" id="imgInp" class="upload" name="slider_image">
                                        <input type="hidden" value="slider" name="storage" >
                                    </div>
                                    <img src="{{asset('vendors/site/AR/images/program-detail-tab-5.jpg')}}" id="blah" class="img-circle" alt="">
                                    <p>    </p>
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Slider Title</label>
                                    <input class="form-control" type="text" name="title_ar" id="title_ar">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Slider Title</label>
                                    <input class="form-control" type="text" name="title_en" id="title_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Slider Header</label>
                                    <input class="form-control" type="text" name="head_ar" id="head_ar">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Slider Header</label>
                                    <input class="form-control" type="text" name="head_en" id="head_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Slider Button</label>
                                    <input class="form-control" type="text" name="button_ar" id="button_ar">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Slider Button</label>
                                    <input class="form-control" type="text" name="button_en" id="button_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Slider Button URL</label>
                                    <input class="form-control" type="text" name="url" id="url">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Slider Content</label>
                                    <textarea rows="2" class="form-control" name="content_ar" id="content_ar"></textarea>
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Slider Content</label>
                                    <textarea rows="2" class="form-control" name="content_en" id="content_en"></textarea>
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-3">
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="slider-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h5 class="mg-b-5 tx-inverse lh-2 " id="slider-title"></h5>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Slider Header:</span>
                                    <span class="mg-b-20" id="slider-header"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">slider Button:</span>
                                    <span class="mg-b-20" id="slider-button"></span>
                                </p>
                                <p class="tx-inverse">
                                        <span class="tx-semibold tx-inverse">Slider Content:</span>
                                        <span class="mg-b-20" id="slider-content"></span>
                                    </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
...
@endsection
@include('admin.pages.slider.scripts')
@include('admin.pages.slider.scripts')