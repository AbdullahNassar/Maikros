...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('feature.get')}}">Hotel Features</a>
            <span class="breadcrumb-item active">Hotel Features Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-section-wrapper">
            ...
            <table id="features_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
        ...
        <div id="featureModal" class="modal fade">
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Feature</h6>
                ...
                <div class="form-layout">
                    <form id="feature_form" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="hidden" value="feature" name="storage" >
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    ...
                                    <input class="form-control" type="text" name="content_ar" id="content_ar">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Content</label>
                                    <input class="form-control" type="text" name="content_en" id="content_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="feature-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h2 class="mg-b-5 tx-semibold tx-inverse" id="feature-name"></h2>
                                <h5 class="mg-b-5 tx-inverse lh-2 " id="feature-title"></h5>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Feature Content:</span>
                                    <span class="mg-b-20" id="feature-content"></span>
                                </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
...
@endsection
@include('admin.pages.hotel_features_requests.scripts')