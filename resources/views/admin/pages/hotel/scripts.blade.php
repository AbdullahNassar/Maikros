    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#add_data').click(function(){
                ...
                $('#comfort').empty();
                $('#comfort').append('<option>             </option>');
                $.ajax({
                    url:"{{route('ajaxdata.comfort')}}",
                    method:'get',
                    dataType:'json',
                    success:function(data)
                    {
                        $.each(data, function(index, comfortObj){
                            $('#comfort').append('<option value="'+comfortObj.id+'">'+comfortObj.c_name_en+'</option>')
                        });
                    }
                });
            });
            ...
            $(document).on('click', '.edit', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $('#comfort').empty();
                            $.ajax({
                                url:"{{route('ajaxdata.hotelcomfort')}}",
                                method:'get',
                                dataType:'json',
                                success:function(data)
                                {
