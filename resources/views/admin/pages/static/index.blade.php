        ...
        <div class="br-section-wrapper">
          <div class="form-layout form-layout-1">
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-12">
                <h4 class="tx-gray-800 mg-b-5">Umrah Packages Page Static Data</h4><hr>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">English Hotels Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="hotels_en">{{$static->hotels_en}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">Arabic Hotels Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="hotels_ar">{{$static->hotels_ar}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">English Programs Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="programs_en">{{$static->programs_en}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">Arabic Programs Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="programs_ar">{{$static->programs_ar}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">English Flights Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="flights_en">{{$static->flights_en}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">Arabic Flights Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="flights_ar">{{$static->flights_ar}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">English Services Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="services_en">{{$static->services_en}}</textarea>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                    <label class="control-label">Arabic Services Section Text</label>
                    <textarea rows="5" class="form-control" type="text" name="services_ar">{{$static->services_ar}}</textarea>
                </div>
              </div>
              <div class="col-lg-12">
                  <h4 class="tx-gray-800 mg-b-5">Terms & Conditions</h4><hr>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="control-label">English Terms</label>
                      <textarea rows="7" class="form-control summernote" name="terms_en">{!! $static->terms_en !!}</textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="control-label">Arabic Terms</label>
                      <textarea rows="7" class="form-control summernote" name="terms_ar">{!! $static->terms_ar !!}</textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="control-label">English Conditions</label>
                      <textarea rows="7" class="form-control summernote" name="conditions_en">{!! $static->conditions_en !!}</textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="control-label">Arabic Conditions</label>
                      <textarea rows="7" class="form-control summernote" name="conditions_ar">{!! $static->conditions_ar !!}</textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="control-label">English Copy Rights</label>
                      <textarea rows="7" class="form-control summernote" name="privacy_en">{!! $static->privacy_en !!}</textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                      <label class="control-label">Arabic Copy Rights</label>
                      <textarea rows="7" class="form-control summernote" name="privacy_ar">{!! $static->privacy_ar !!}</textarea>
                  </div>
                </div>
            </div><!-- row -->
