    ...
    <nav class="nav">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-header wd-300 pd-0-force">
          ...
          <div class="media-list">
            ...
            <a href="" class="media-list-link read">
              <div class="media pd-x-20 pd-y-15">
                <img src="{{asset('storage/uploads/user').'/'.Auth::guard('admins')->user()->image}}" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
                  <p class="tx-13 mg-b-0 tx-gray-700"><strong class="tx-medium tx-gray-800">{{Auth::guard('admins')->user()->name}}</strong>  @include('admin.layouts.partials.notifications.'.snake_case(class_basename($notification->type)))</p>
      ...
      <div class="dropdown">
        <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
          ...
          <img src="{{asset('storage/uploads/user').'/'.Auth::guard('admins')->user()->image}}" class="wd-32 rounded-circle" alt="">
