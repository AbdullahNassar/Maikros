...
class StaticController extends Controller {
    ...
    function postdata(Request $request){
        ...
        if($request->get('button_action') == 'update'){
            ...
            $static2->hotels_ar = $request->hotels_ar;
            $static2->hotels_en = $request->hotels_en;
            $static2->programs_ar = $request->programs_ar;
            $static2->programs_en = $request->programs_en;
            $static2->flights_ar = $request->flights_ar;
            $static2->flights_en = $request->flights_en;
            $static2->services_ar = $request->services_ar;
            $static2->services_en = $request->services_en;

            $static2->terms_ar = $request->terms_ar;
            $static2->terms_en = $request->terms_en;
            $static2->conditions_ar = $request->conditions_ar;
            $static2->conditions_en = $request->conditions_en;
            $static2->privacy_ar = $request->privacy_ar;
            $static2->privacy_en = $request->privacy_en;
