...
class PendingHotelRoomsController extends Controller
{
    public function getIndex() {
        return view('admin.pages.hotel_rooms_requests.index');
    }

    public function getdata() {
        $hotel_rooms = HotelRooms::select('id','r_name_en','price')->where('active','=', -1)->get();
